...
## 文档链接
📚 组件详细文档请访问以下站点：
- [打卡日历文档 - 站点1](https://limex.qcoon.cn/components/daily-punch.html)
- [打卡日历文档 - 站点2](https://limeui.netlify.app/components/daily-punch.html)
- [打卡日历文档 - 站点3](https://limeui.familyzone.top/components/daily-punch.html)

## 安装方法
1. 在uni-app插件市场中搜索并导入`lime-daily-punch`
2. 首次导入可能需要重新编译
