	...
	export default defineComponent({
		...
		setup(props, { emit }) {
			...
			const styles = computed(() => {
				...
				if (props.zIndex) {
					style['--l-tabbar-z-index'] = props.zIndex!
				}
				if (props.bgColor) {
					style['--l-tabbar-bg-color'] = props.bgColor!
				}
				if (props.fontSize) {
					style['--l-tabbar-font-size'] = props.fontSize
				}
				if (props.activeBgColor) {
					style['--l-tabbar-active-bg-color'] = props.activeBgColor
				}
				if (props.activeColor) {
					style['--l-tabbar-active-color'] = props.activeColor
				}
				if (props.color) {
					style['--l-tabbar-color'] = props.color
				}
				return style
			})
