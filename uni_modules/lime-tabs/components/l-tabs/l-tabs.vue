<template>
	<view class="l-tabs">
		...
		<view class="l-tabs__content" @touchstart="onTouchStart" @touchmove="onTouchMove" @touchend="onTouchEnd"
			@touchcancel="onTouchEnd" :class="{'l-tabs__content--animated': animated}"  :style="[contentStyle]" v-if="$slots['default']">
...
<script lang="ts">
	 ...
	 * @property {boolean} immediate 是否跳过首次动画 默认是false
	...
	import type { TabPanel } from './type';
