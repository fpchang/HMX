...
## 文档
  [grid【站点1】](https://limex.qcoon.cn/components/grid.html)
  [grid【站点2】](https://limeui.netlify.app/components/grid.html)
  [grid【站点3】](https://limeui.familyzone.top/components/grid.html)
...
| 名称 | 默认值 | 描述 |
| --- | --- | --- |
| --l-grid-item-padding-top: | _16px_ | - |
| --l-grid-item-padding-bottom: | _12px_ | - |
| --l-grid-item-bg-color: | _white_ | - |
| --l-grid-item-image-bg-color: | _$fill-4_ | - |
| --l-grid-item-image-border-radius: | _$border-radius_ | - |
| --l-grid-item-image-width: | _48px_ | - |
| --l-grid-item-image-small-width: | _16px_ | - |
| --l-grid-item-image-middle-width: | _40px_ | - |
| --l-grid-item-text-color: | _$text-color-1_ | - |
| --l-grid-item-text-font-size: | _14px_ | - |
| --l-grid-item-text-small-font-size: | _12px_ | - |
| --l-grid-item-text-line-height: | _22px_ | - |
| --l-grid-item-text-padding-top: | _8px_ | - |
| --l-grid-item-description-font-size: | _12px_ | - |
| --l-grid-item-description-line-height: | _40rpx_ | - |
| --l-grid-item-description-color: | _$text-color-3_ | - |
| --l-grid-item-description-padding-top: | _4px_ | - |
| --l-grid-item-hover-bg-color: | _$fill-4_ | - |
| --l-grid-item-horizontal-text-padding-left: | _12px_ | - |
| --l-grid-item-horizontal-text-description-top: | _2px_ | - |
| --l-grid-item-border-color: | _$border-color-1_ | - |
| --l-grid-item-icon-size: | _24px_ | - |
| --l-grid-item-icon-color: | _$text-color-1_ | - |
